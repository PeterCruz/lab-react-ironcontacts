    ...
    render() {
        ...
        return(
            <div className='container'>
                <h1>IronContacts</h1>
                <section>
                    <Button buttonName='+ Add Random Contact' onClick={this.getRandom}/>
                    <Button buttonName='∨ Sort by name' onClick={this.sortByName}/>
                    <Button buttonName='∧ Sort by popularity' onClick={this.sortByPopularity}/>
                </section>
                <table>
                    <thead>
                        <tr>
                    ...
                    {state.arr.map((item, index) =>
                        <Item key={index} index={index} item={item} onClick={this.deleteContact}/>
                        )}
                    </tbody>
                </table>
            </div>
